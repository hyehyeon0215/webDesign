$(document).ready(function() {
    ...
    // l덱스의 버튼 활성화와 비활성화에 대한 코드

    $('#gnb>li').on('mouseenter', function(){
        $(this).children('a').addClass('on');

        // find와 children의 차이점
        // find는 다 찾음 children은 바로 밑에 있는 직계 자식만 찾음
    });
    ...
    $('#gnb').on('mouseenter', function() {
        ...
        // 무한 반복해서 .bgGnb를 생성하지 않도록 변수로 해당 클래스의 여부를 담은 뒤 if문으로 해당 클래스의 존재에 따라서 한 번만 생성하도록 코드를 작성
...
//     $('#gnb').on('mouseenter', function () {
//         // 무한 반복해서 .bgGnb를 생성하지 않도록 변수로 해당 클래스의 여부를
